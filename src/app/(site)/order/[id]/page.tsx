      ...
      dayjs() < dayjs(user?.pointsExpirationDate) ? (
        <div className="mx-auto max-w-4xl space-y-5 px-3 py-5 text-center">
          <div>
            ...
            <p>
              Car posting is currently free until Nov 13, 2023. Your can will be
              published after review
            </p>
          </div>
          <h4 className="font-bold">
            If you would like to make your car featured on home page:{" "}
            <s>ETB 1000</s> ETB 500 - Featured post
          </h4>
        ...
        <div className="mx-auto max-w-4xl space-y-5 px-3 py-5 text-center">
          ...
          <span>
            Payment can be done via your nearest branch of CBE (Commercial Bank
            of Ethiopia)
          </span>
          <h4 className="font-bold">Account number: 1000036123428</h4>
          <h4 className="font-bold">Name: Araya Lakew</h4>
          <div>
            or in our office: Bole road, Getu Commercial Center 4th floor Room
            405
          </div>
          <Separator />
