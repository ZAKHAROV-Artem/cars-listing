  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="text-disabled text-[12px] sm:text-sm">{`${car.attributes.car_ch?.year_made} | ${car.attributes.car_ch?.fuel} | የለጠፈ`}</div>
        <div className="hidden mt-3 flex justify-between text-xs">
          <div>
            {formatDistance(
