...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      `inline-flex h-14 w-full max-w-lg items-center justify-center gap-x-1 rounded-full
      bg-paper-light p-1 text-slate-500 shadow-xl dark:bg-accent-dark dark:text-slate-400`,
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      `inline-flex h-full w-full items-center justify-center whitespace-nowrap rounded-3xl
      ...
      disabled:opacity-50 data-[state=active]:bg-paper-dark data-[state=active]:text-white
